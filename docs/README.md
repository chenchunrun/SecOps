...
This repository keeps only public-facing guides and legal/licensing records
under `docs/` so the repository root stays focused on product entry points and
standard metadata.
...
Process records such as release-closeout notes, validation logs, project
tracking, and working security documents are intentionally kept out of the
